...
class TopicServiceImpl(
    ...
    private val contentRepository: ContentJpaRepository,
    ...
    override fun getContentById(contentId: Long): ContentResponse {
        return contentRepository.findByIdWithReviews(contentId)?.toDto() ?: throw ServiceException(
    ...
    override fun getContent(id: Long, page: Int): ContentListResponse {
        ...
        return ContentListResponse(
            content = pageResponse.map(ContentWithReviewView::toDto),
            page = page,
    ...
    override fun searchContent(id: Long, query: String): List<ContentResponse> {
        ...
        return pageResponse.map(ContentWithReviewView::toDto)
    }
